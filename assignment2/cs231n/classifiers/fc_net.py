...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        out_relu1, cache_relu1 = relu_forward(out_layer1)
        out_layer2, cache_layer2 = affine_forward(out_relu1, self.params['W2'], self.params['b2'])
        scores = out_layer2
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dout, grads['W2'], grads['b2'] = affine_backward(dout, cache_layer2)
        dout = relu_backward(dout, cache_relu1)
        dout, grads['W1'], grads['b1'] = affine_backward(dout, cache_layer1)
